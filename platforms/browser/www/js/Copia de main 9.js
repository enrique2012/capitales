var app = {
	...
	finJuego: function(){
		...
		html+='<h1 class="centraTexto mayusculas">' + hiScoreNombre + ' ---> ' + hiScorePuntos + '</h1>';
		html+='<button class="centraTexto">$$$ HISCORE $$$</button>';
		...
		botonNuevoJuego.addEventListener('click',app.recargaPagina,false);
	},
