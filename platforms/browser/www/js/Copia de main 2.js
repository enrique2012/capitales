var app = {
	...
	model: {
		"record": [{"nombre" : "Enric", "puntuacion" : 3000}]
	},
	...
	finJuego: function(){
		...
		html+='<hr>';
		html+='<h2 class="centraTexto">HISCORES:</h2>';
		html+='<table><tr><th>'+ hiScores[0].nombre +'</th><td>' + hiScores[0].hiScore + '</td></th>';
		html+='<tr><th>'+ hiScores[1].nombre +'</th><td>' + hiScores[1].hiScore + '</td></th>';
		html+='<tr><th>'+ hiScores[2].nombre +'</th><td>' + hiScores[2].hiScore + '</td></th></table>';
